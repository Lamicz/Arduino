...
#define PIXELS_CNT 35 // pixelsMinMax[1]
  ...
  byte pixelCurrentMode = 1; // [0 - no flash, 1 - flash, 2 - only flash, 3 - RGB]

#else // trinket new strip

  #define NEOPIXEL_DATA 1
  #define STRIP_LENGTH 288
  #define BUTTON_SWITCH 0
  #define BUTTON_TOUCH A3
  #define DOTSTAR_DATA 7
  #define DOTSTAR_CLK 8
  byte pixelCurrentMode = 0; // [0 - no flash, 1 - flash, 2 - only flash, 3 - RGB]
#endif
...
word stripLengthCurrent = STRIP_LENGTH;
